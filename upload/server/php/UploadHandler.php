...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        //start added by leathan
        $un='';
        if (!$_COOKIE['SESSION_ID']) { die("Cookie Error! You are not logged in? <a href='../CLogin.php'>click here</a> to login."); }
        ...
        //End added by leathan


        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$un,
            'upload_url' => $this->get_full_url().'/files/'.$un.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            */
            ...
            'image_versions' => array(
                ...
                'thumbnail' => array(
                    ...
                    'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$un.'/thumb',
                    'upload_url' => $this->get_full_url().'/files/'.$un.'/'.'thumb/',
